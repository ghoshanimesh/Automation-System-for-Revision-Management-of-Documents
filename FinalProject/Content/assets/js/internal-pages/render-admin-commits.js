$('#branch_select').change(function () {
    ...
    $.ajax({
        url: '/Admin/ViewRepository/UpdateCommits',
        type: 'POST',
        ...
        for (var i = 0; i < obj.length; i++) {
            ...
            finalrow += "<td><a href='/Admin/ViewRepository/DownloadFileVersion?doc_ver_id=" + obj[i].Id + "' class='btn btn-primary mr-2'><i class='fa fa-download'></i></a></td></tr>";
